...
#    print(m[[1]]$test)
    ...
    intdf$wordstr = ifelse(intdf$pval > 0.1,paste("@@Posthoc: There was no difference for ",row.names(intdf),", p=",intdf$pval,sep=""), intdf$wordstr )
...
```{r}
test = read.csv("results/testdata.csv")
